...
import docinsMenuStyles from '../styles/docins/docinsMenu.css'
...
class DocinsDropdownMenu extends React.Component {
    ...
    renderCharactersDocinToggle() {
        ...
        return (
            <li
                onClick={() =>
                    setCharactersDocinVisibility(!isCharactersDocinVisible)
                }
            >
                Characters
                {toggleIcon}
    ...
    renderOutlineDocinToggle() {
        ...
        return (
            <li
                onClick={() =>
                    setOutlineDocinVisibility(!isOutlineDocinVisible)
                }
            >
                Outline
                {toggleIcon}
